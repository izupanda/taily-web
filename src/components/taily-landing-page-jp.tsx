          ...
          <div className="container mx-auto px-4 md:px-6">
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              {[
                ...
                { icon: BarChart3, title: "マーケティング効果の測定が不十分", content: "広告やプロモーョンの効果を、売上だけなく利益の観点から正確に評価できていません。これにより、効果的なマーケティング戦略の立案や予算配分の最適化が困難です。" },
          ...
          <div className="container mx-auto px-4 md:px-6">
            ...
            <div className="grid gap-6 items-stretch md:grid-cols-2 lg:grid-cols-3">
              {[
                ...
                { icon: PieChart, title: "在庫最適化", content: "SKU別の在庫回転率と利益を連動して分析し、最適な在庫水準を提案。過剰と欠品リスクを最小化します。" },
              ...
              {[
                {
                  icon: Rocket,
                  title: "利益率の向上",
                  content: "SKU別の利益分析により、高収益商品に注力し、低収益商品を改善または廃止することで、全体の益率が向上します。平均して20%上の利益率改善を実現しています。",
                  details: [
                    "高収益SKUの特定と在庫最適化",
                    "低収益SKUの改善または廃止",
                    "価格戦略の最適化による利益率向上"
